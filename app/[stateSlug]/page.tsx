...
export async function generateMetadata({
  ...
  const descriptor = `Browse ${totalFacilities.toLocaleString()} verified auto repair shops across ${cities.length.toLocaleString()} ${stateName} cities. Diagnostics, brake service, tire rotation, and more — all rated 3 stars or higher.`;
